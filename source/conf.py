...
htmlhelp_basename = 'ehyd_toolsdoc'
...
latex_documents = [
    (master_doc, 'ehyd_tools.tex', 'ehyd\\_tools Documentation',
     'Pichler', 'manual'),
]
...
man_pages = [
    (master_doc, 'ehyd_tools', 'ehyd_tools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ehyd_tools', 'ehyd_tools Documentation',
     author, 'ehyd_tools', 'One line description of project.',
     'Miscellaneous'),
]
